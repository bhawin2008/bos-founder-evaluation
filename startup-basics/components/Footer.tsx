    ...
    <footer className="bg-primary text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            <h3 className="text-xl font-bold mb-3">
              Startup<span className="text-accent-light">Basics</span>
            </h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-gray-400 mb-4">Navigate</h4>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { href: "/programs", label: "Join Cohort" },
              ].map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-gray-300 hover:text-white transition-colors">
                    {link.label}
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-sm text-gray-500">
          &copy; {new Date().getFullYear()} Startup Basics. All rights reserved.
        </div>
      </div>
    </footer>
  );
