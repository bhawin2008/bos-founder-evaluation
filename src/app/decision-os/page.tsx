...
import { VERDICT_LABELS, VERDICT_COLORS, CATEGORY_LABELS } from "./_lib/constants";
import { Badge } from "./_components/ui/badge";
import { getRecentDecisions, getTotalCount } from "./_lib/actions";
...
export default function HomePage() {
  ...
  useEffect(() => {
    setRecentDecisions(getRecentDecisions(5));
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {recentDecisions.map((d) => (
              <Link
                key={d.id}
                href={`/decision-os/decisions/${d.id}`}
